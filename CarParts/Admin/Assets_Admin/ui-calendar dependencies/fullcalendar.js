...
var DragListener = fc.DragListener = Class.extend({
	...
	scrollIntervaCarParts: 50, // millisecond wait between scroll increment
	...
	scrollIntervalFunc: function() {
		var el = this.scrollEl;
		var frac = this.scrollIntervaCarParts / 1000; // considering animation frequency, what the vel should be mult'd by
